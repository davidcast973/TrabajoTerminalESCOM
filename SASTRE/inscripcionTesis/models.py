...
class Tesis(models.Model):
	...
	director2Aps= models.CharField("Apeido(s) de director 1", max_length=50, default= "", null=True)
	director2= models.CharField("Nombre de director 1", max_length=50, default= "", null=True)
